...
void CGame::SwitchScene(int scene_id, int _level, int _blood, int _heart, int _alive, int _scores, int _weapon)
{
	...
	s->Load(_level, _blood, _heart, _alive, _scores, _weapon);
}
